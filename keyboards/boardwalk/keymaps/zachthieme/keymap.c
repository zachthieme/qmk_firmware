...
#define LAYOUT_ortho_5x14_base( \
  ...
  LAYOUT_ortho_5x14_wrapper( \
    ...
    K20,        K21,       K22,     K23,      K24,     K25,    BB2,      BB3,      K26,     K27,      K28,       K29,     K2A,    K2B, \
    KC_NO,      KC_HOME,   KC_END,  K30,      K31,     BB1,    KC_NO,    KC_NO,    BB1,     KC_MINS,  K32,       K33,     KC_NO,  KC_NO \
    )

#define LAYOUT_ortho_5x14_base_wrapper(...)       LAYOUT_ortho_5x14_base(__VA_ARGS__)

const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [_QWERTY] = LAYOUT_ortho_5x14_base_wrapper(
    ...
    // [_WORKMAN] = LAYOUT_ortho_5x14_base_wrapper(
    ...
    [_NAVIGATION] = LAYOUT_ortho_5x14_base_wrapper(
    ...
    [_NUMBERS] = LAYOUT_ortho_5x14_base_wrapper(
    ...
    [_SCREEN] = LAYOUT_ortho_5x14_base_wrapper(
    ...
    [_MOUSE] = LAYOUT_ortho_5x14_base_wrapper(
