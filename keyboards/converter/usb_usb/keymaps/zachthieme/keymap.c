...
#define LAYOUT_all_base( \
  ...
  LAYOUT_all( \
    ...
    K00,     K01,     K02,     K03,     K04,     K05,    K06,    K07,    K08,     K09,     K0A,     K0B,     KC_RBRC,          KC_BSLS,     KC_DEL,  KC_END,  KC_PGDN,    KC_P7,   KC_P8,   KC_P9,   KC_PPLS,    KC_MENU, KC_UNDO, \
    ...
    KC_LCTL, KC_LGUI, BB2, KC_MHEN, KC_HANJ,         BB1,         KC_HAEN, KC_HENK, KC_KANA, KC_RALT, KC_RGUI, KC_APP,  KC_RCTL,     KC_LEFT, KC_DOWN, KC_RGHT,    KC_P0,            KC_PDOT, KC_PENT,    KC_FIND, KC_CUT \
  )
