...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    ______,  ______,  ______,  ______, ______, ______, KC_MAC_BEGLINE,  KC_LEFT, KC_DOWN, KC_RIGHT,  KC_MAC_ENDLINE, ______,         ______, ______,                              ______,______,______,______,    ______,______,
    ______,  ______,  ______,  KC_HOME,  KC_END, KC_G, ______,  ______,  ______, ______,  KC_ESCAPE, ______,         ______, ______,            ______,           ______,______,______,______,    ______,______,
    ______,  ______,  ______,  ______,  ______,         ______,           ______, ______,  ______, ______, ______, ______, ______,     ______,______,______,    ______,       ______,______,    ______,______
  ),
    [2] = LAYOUT_all(
                      ______,  ______,  ______, ______, ______,  ______,  ______, ______,  ______, ______, ______, ______,
