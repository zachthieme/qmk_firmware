...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [0] = LAYOUT_ergodox_pretty(
    ...
    KC_MAKE,          KC_HOME,      KC_END,         KC_LGUI,        KC_LBRACKET,                                                                                                    KC_MINUS,       KC_BSPACE,      KC_NO,          KC_NO,        LT(4,KC_NO),
  ...
  [2] = LAYOUT_ergodox_pretty(
    ...
    KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT,                                                                 KC_0,           KC_4,           KC_5,           KC_6,           KC_KP_SLASH,    KC_KP_MINUS,
