...
#define _________________NUMBER_R4_________________        KC_P0, KC_PDOT
...
#define ___________________NAV_R3__________________        B_GTOP, KC_PGUP, KC_PGDN,  _______,  B_GEND, Z_KVM_3
